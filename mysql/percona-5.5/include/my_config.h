...
#define DEFAULT_MYSQL_HOME "/opt/TopPatch/mysql/percona-5.5"
#define SHAREDIR "/opt/TopPatch/mysql/percona-5.5/share"
#define DEFAULT_BASEDIR "/opt/TopPatch/mysql/percona-5.5"
#define MYSQL_DATADIR "/opt/TopPatch/mysql/percona-5.5/data"
#define DEFAULT_CHARSET_HOME "/opt/TopPatch/mysql/percona-5.5"
#define PLUGINDIR "/opt/TopPatch/mysql/percona-5.5/lib/plugin"
#define DEFAULT_SYSCONFDIR "/opt/TopPatch/mysql/percona-5.5/etc"
