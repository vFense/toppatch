...
session.add(u3)
session.commit()
s1 = SystemInfo(2, 'Windows', 'Windows XP', None, None, None, 'SP3')
s2 = SystemInfo(1, 'Windows', 'Windows 7', None, None, None, 'SP1')
...
session.add(n1)
w0 = WindowsUpdate("20120902", "Chrome", "Chrome 20", "1st best browser", "http://google.chrome.com", "Critical", datetime.date(month=9, year=2012, day=1))
...
session.add(w1)
session.commit()
w2 = ManagedWindowsUpdate(1, '20120901', datetime.datetime.now(), False, False)
w4 = ManagedWindowsUpdate(1, '20120902', datetime.datetime.now(), False, True)
w3 = ManagedWindowsUpdate(2, '20120901', datetime.datetime.now(), False, True)
w5 = ManagedWindowsUpdate(2, '20120902', datetime.datetime.now(), False, True)
w6 = ManagedWindowsUpdate(3, '20120901', datetime.datetime.now(), False, False)
w7 = ManagedWindowsUpdate(3, '20120902', datetime.datetime.now(), False, False)
session.add(w2)
session.add(w3)
session.add(w4)
session.add(w5)
session.add(w6)
session.add(w7)
n0 = NodeStats(1, 1, 1, 0, 0) #node_id, patches_installed, patches_available, patches_pending, patches_failed
n1 = NodeStats(2, 2, 0, 0, 0)
n2 = NodeStats(3, 0, 2, 0, 0)
session.add(n0)
session.add(n1)
session.add(n2)
g0 = NetworkStats(3, 3, 0, 0)
session.add(g0)
